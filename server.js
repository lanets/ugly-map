...
function queryProm() {
    ...
    request(config.prometheus.url + "/api/v1/query?query=probe_success{instance=~'d([0-9]|1[0-2]).event.dhmtl.ca|(.*).sw.dhmtl.ca', job='blackbox-ping'}", { json: true }, (err, res, body) => {
